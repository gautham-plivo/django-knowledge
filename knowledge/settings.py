...
ALERTS_FUNCTION_PATH = getattr(
    settings, "KNOWLEDGE_ALERTS_FUNCTION_PATH", "knowledge.signals.send_alerts"
)
...
BASE_TEMPLATE = getattr(
    settings, "KNOWLEDGE_BASE_TEMPLATE", "django_knowledge/base.html"
)
